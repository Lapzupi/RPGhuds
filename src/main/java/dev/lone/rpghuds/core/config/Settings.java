...
public class Settings extends YamlConfigurateFile<Main> {
    ...
    protected void initValues() throws ConfigurateException {
        ...
        this.msgHudNotFound = Utils.color(langNode.node("hud_not_found").getString("&6Hud not found!"));
        this.msgWrongUsage = Utils.color(langNode.node("wrong_usage").getString("&cWrong command usage."));
        this.msgDestinationSet = Utils.color(langNode.node("destination_set").getString("&aDestination set."));
        this.msgDestinationRemoved = Utils.color(langNode.node("destination_removed").getString("&7Destination removed."));
